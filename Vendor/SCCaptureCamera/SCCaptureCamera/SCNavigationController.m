...
- (void)showCameraWithParentController:(UIViewController*)parentController {
    ...
    [self showCameraWithParentController:parentController previewRect:CGRectZero];
}

- (void)showCameraWithParentController:(UIViewController*)parentController previewRect:(CGRect)previewRect{
    SCCaptureCameraController *con = [[SCCaptureCameraController alloc] init];
    con.albumName = self.customAlbumName;
    con.previewRect = previewRect;
